...
namespace MaterialSkin.Controls
{
    public class MaterialTabSelector : Control, IMaterialControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                var rippleBrush = new SolidBrush(Color.FromArgb((int)(51 - (animationProgress * 50)), Primary ? Color.White : SkinManager.ColorScheme.DarkPrimaryColor));
            ...
            foreach (TabPage tabPage in _baseTabControl.TabPages)
            {
                ...
                Brush textBrush = new SolidBrush(Color.FromArgb(CalculateTextAlpha(currentTabIndex, animationProgress), Primary ? SkinManager.ColorScheme.TextColor : SkinManager.ColorScheme.LightPrimaryColor));
