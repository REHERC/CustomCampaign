...
namespace MaterialSkin
{
    public sealed class MaterialSkinManager
    {
        ...
        public Color GetCmsSelectedItemColor()
        {
            return Theme == Themes.LIGHT ? CMS_BACKGROUND_LIGHT_HOVER : CMS_BACKGROUND_DARK_HOVER;
        }
        ...
        public Font GetFont(float size, bool regular = true)
        {
