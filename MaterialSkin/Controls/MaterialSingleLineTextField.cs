...
namespace MaterialSkin.Controls
{
    public class MaterialSingleLineTextField : Control, IMaterialControl
    {
        ...
        public MaterialSingleLineTextField()
        {
            ...
            {
                _baseTextBox.BackColor = SkinManager.GetApplicationBackgroundColor();
                _baseTextBox.ForeColor = SkinManager.Theme == MaterialSkinManager.Themes.LIGHT ? SkinManager.GetPrimaryTextColor() : Color.White;
            };
